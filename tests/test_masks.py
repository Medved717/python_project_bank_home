...
@pytest.mark.parametrize("number_card, expected_result",[
...
@pytest.mark.parametrize("number_account, expected_result1",[
...
def test_get_mask_account(number_account, expected_result1):
    assert get_mask_account(number_account) == expected_result1
