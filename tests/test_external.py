...
from src.utils.operations_json import operations_json
...
@patch("requests.get")
def test_covert_to_rub(mock_response_json):
    mock_response_json.return_value.json.return_value = {'success': True, 'query': {'from': 'USD', 'to': 'RUB', 'amount': 79114.93},
